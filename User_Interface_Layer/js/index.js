(function (d) {
	var f = d.pageConfig;
	f.clstagPrefix = "h|keycount|2016|";
	f.clog = {};
	var b = function (h) {
		if (h && h.length) {
			var g = h.length;
			var i = Math.floor(Math.random() * g);
			return h[i]
		}
	};
	var a = function (j) {
		...
		if (m.querySelectorAll) {
			return m.querySelectorAll("." + j)
		}
		if (m.evaluate) {
			k = ".//*[contains(concat(' ', @class, ' '), ' " + j + " ')]";
			l = m.evaluate(k, m, null, 0, null);
			while ((h = l.iterateNext())) {
				g.push(h)
			}
		} else {
	...
	function c() {
		...
		var k = "";
		var j = a("J_slider")[0];
		var m = a("J_slider_main")[0];
		var i = f.compatible && f.wideVersion;
		if (l && l.length) {
			var n = l.length;
			if (n) {
				l = b(l);
				f.clog.logDomain = l.logDomain;
				f.clog.logV = l.logV;
				var o = i ? l.src : l.srcB;
				h += '<li class="J_slider_item slider_item">                        <a href="' + l.href + '" class="slider_item_lk mod_loading  J_slider_item_lk" fclog="' + l.clog + '" clstag="' + f.clstagPrefix + "08a01" + '" target="_blank">                        <img data-lazy-src="' + o + '" alt="' + l.alt + '" src="//misc.360buyimg.com/mtd/pc/common/img/blank.png" class="J_slider_item_img slider_item_img" />                        </a>                    </li>'
			}
		}
		k = '<ul class="slider_list J_slider_list">' + h + '</ul>              <div class="J_slider_indicator slider_indicator"></div><a href="javascript:void(0)" clstag="" class="J_slider_control_prev slider_control_item slider_control_prev"><i class="iconfont">&#xe602;</i></a><a href="javascript:void(0)" clstag="" class="J_slider_control_next slider_control_item slider_control_next"><i class="iconfont">&#xe601;</i></a>';
		m.innerHTML = k;
		m.className = m.className.replace(new RegExp("(\\s|^)mod_lazyload(\\s|$)"), "");
		var g = a("J_slider_item_img")[0];
		var p = g.parentNode;
		e(g, function () {
			g.removeAttribute("data-lazy-src");
			p.className = p.className.replace(new RegExp("(\\s|^)mod_loading(\\s|$)"), "")
		}, function () {
			var q = p.parentNode;
			var r = q.parentNode;
			r.removeChild(q)
	...
	function e(j, h, i) {
		...
		var g = j.getAttribute("data-lazy-src");
		if (g && g.length) {
			var k = false;
...
(function () {
	pageConfig.liftTxtArr = ['服饰美妆', '家电手机', '电脑数码', '3 C运动', '爱吃', '母婴家居', '图书汽车', '虚拟', '还没逛够'];
}
	());
...
!function (a, b) {
	!function () {
		...
		"undefined" == typeof b.browser ? b.browser = {
		 ...
		 : (b.browser.webkit || (b.browser.webkit = /webkit/.test(a)), b.browser.mozilla && (b.browser.msie = /trident/.test(a))),
	...
	b.T = {
		...
		search: function () {
			...
			return b.each(location.search.substring(1).split("&"), function (d, e) {
				if (e = e.replace(/\%20/g, "").replace("=", c).split(c), e[0])
					if ("isdebug" == e[0] && e[1]) {
						var f = {};
			...
			var D = {
				create: function (a, c, d) {
					...
					if ("1.0.0" == j.baseVersion)
						O(i);
							...
							if (!k)
								return !1;
							if (k !== !0)
								return k.selector = a.selector, k.init(d), k.cache("origin_options", b.extend(i.cache("origin_options"), d)), k;
							H.createClass(i),
					...
					register: function (a, c) {
						...
						var h = {};
						return "2.0.0" == c.options.baseVersion && (h = g),
						e.length ? d = b.extend.apply(b, [!0, {}, f, h].concat(e).concat([c])) : (_(a, c), d = b.extend(!0, {}, f, h, c)),
						C[a] = d,
						d.name = a,
						B[a] = [],
						!0
				...
				var E = {
					...
					define: I("define", function (a, c) {
						...
						r.test(a) && (a = a.replace(s, ""), c.options.baseVersion = "2.0.0"),
						E[a] ? E[a] : D.register(a, c) ? (E[a] = Z(C[a], d), X(a), Y(a), E[a]) : !1
					}),
					all: I("all", function () {
						return b.extend(!0, {}, B)
					}),
					...
					helper: I("helper", function (a) {
						if ("object" != typeof seajs)
							return console.error("require seajs.js!"), !1;
				...
				H.prototype.on = function (a, c) {
					if (a && b.isFunction(c)) {
						...
						if (a = a.toLowerCase(), p.test(a)) {
							var e = a.split("#");
							if (d.eventIDs[a])
								return d.off(a, d.eventIDs[a]), d.on(a, c), !1;
							d.eventIDs[a] = c,
							a = e[0]
						}
				...
				function K(a, b) {
					var c = a.options;
					if (c.hasCssLink && "undefined" != typeof seajs && c.cssLinkVersion && c.baseVersion)
						seajs.use(("https:" == document.location.protocol ? "https:" : "http:") + "//misc.360buyimg.com/jdf/" + c.baseVersion + "/ui/" + b + "/" + c.cssLinkVersion + "/" + b + ".css", function () {
							c.isAutoInit && a.init()
						});
				...
				function U(a) {
					...
					a.init = I("init", function () {
							...
							a.loadAllEls(),
							$(a),
							b.isFunction(c) && (d = c.apply(a, arguments), d === !1) ? void 0 : (b.T.call(a, a.options.onReady, d), a)
						})
				}
				function V(c, d) {
					var e = d.attr(t);
...
!function (e, t) {
	...
	function c(e) {
		var t,
		r = A.paths;
		return r && (t = e.match(U)) && w(r[t[1]]) && (e = r[t[1]] + t[2]),
		e
	}
	function u(e) {
		var t = A.vars;
	...
	function l(e) {
		...
		if (t)
			for (var n = 0, i = t.length; i > n; n++) {
				var a = t[n];
				if (r = j(a) ? a(e) || e : e.replace(a[0], a[1]), r !== e)
					break
			}
		return r
	}
	function f(e, t) {
		...
		if (O.test(e))
			...
			r = A.base + e;
		return 0 === r.indexOf("//") && (r = ("https:" == location.protocol ? "https:" : "http:") + r),
		r
	}
	function h(e, t) {
		if (!e)
	...
	function m(e, t, r) {
		var n = H.test(e),
		i = R.createElement(n ? "link" : "script");
		if (r) {
			var a = j(r) ? r(e) : r;
			a && (i.charset = a)
		}
		p(i, t, n, e),
		n ? (i.rel = "stylesheet", i.href = e) : (i.async = !0, i.src = e),
		K = i,
		V ? B.insertBefore(i, V) : B.appendChild(i),
		K = null
	}
	function p(e, r, n, i) {
		function a() {
			e.onload = e.onerror = e.onreadystatechange = null,
			n || A.debug || B.removeChild(e),
			e = null,
			r()
		}
		var o = "onload" in e;
	...
	if (!e.seajs) {
		...
		M = i(R.URL),
		G = R.scripts,
		L = R.getElementById("seajsnode") || G[G.length - 1],
		$ = i(d(L) || M);
		E.resolve = h;
		var K,
		Y,
		B = R.getElementsByTagName("head")[0] || R.documentElement,
		V = B.getElementsByTagName("base")[0],
		H = /\.css(?:\?|$)/i,
		P = +navigator.userAgent.replace(/.*AppleWebKit\/(\d+)\..*/, "$1") < 536;
		E.request = m;
		var X,
		...
		b.prototype.resolve = function () {
			for (var e = this, t = e.dependencies, r = [], n = 0, i = t.length; i > n; n++)
				r[n] = b.resolve(t[n], e.uri);
			return r
		},
		b.prototype.load = function () {
			...
			if (!(e.status >= te.LOADING)) {
				...
				var r = e.resolve();
				S("load", r);
				for (var n, i = e._remain = r.length, a = 0; i > a; a++)
					n = b.get(r[a]), n.status < te.LOADED ? n._waitings[e.uri] = (n._waitings[e.uri] || 0) + 1 : e._remain--;
				if (0 === e._remain)
					return e.onload(), t;
				var o = {};
				for (a = 0; i > a; a++)
					n = J[r[a]], n.status < te.FETCHING ? n.fetch(o) : n.status === te.SAVED && n.load();
				for (var s in o)
		...
		b.prototype.onload = function () {
			...
			n = e._waitings;
			for (t in n)
				n.hasOwnProperty(t) && (r = J[t], r._remain -= n[t], 0 === r._remain && r.onload());
			delete e._waitings,
			delete e._remain
		},
		...
		b.prototype.exec = function () {
			...
			e.async = function (t, r) {
				return b.use(t, r, i + "_async_" + n()),
				e
			};
			var a = r.factory,
			o = j(a) ? a(e, r.exports = {}, r) : a;
			return o === t && (o = r.exports),
			delete r.factory,
			r.exports = o,
			r.status = te.EXECUTED,
			S("exec", r),
			o
		},
		...
		b.define = function (e, r, n) {
			...
			1 === i ? (n = e, e = t) : 2 === i && (n = r, x(e) ? (r = e, e = t) : r = t),
			!x(r) && j(n) && (r = y("" + n));
			var a = {
				id: e,
				uri: b.resolve(e),
		...
		b.use = function (t, r, n) {
			...
			i.callback = function () {
				for (var t = [], n = i.resolve(), a = 0, o = n.length; o > a; a++)
					t[a] = J[n[a]].exec();
				r && r.apply(e, t),
				delete i.callback
			},
		...
		E.require = function (e) {
			...
			return t.status < te.EXECUTING && t.exec(),
			t.exports
		};
		var re = /^(.+?\/)(\?\?)?(seajs\/)+/;
		A.base = ($.match(re) || ["", $])[1],
		...
		E.config = function (e) {
			for (var t in e) {
				...
				if (n && _(n))
					...
					x(n) ? r = n.concat(r) : "base" === t && ("/" !== r.slice(-1) && (r += "/"), r = f(r)), A[t] = r
			}
			return S("config", e),
			E
		}
...
(this), !function () {
	function e(e) {
		var t = e.length;
		if (!(2 > t)) {
			g.comboSyntax && (y = g.comboSyntax),
			g.comboMaxLength && (b = g.comboMaxLength),
			d = g.comboExcludes;
			for (var n = [], i = 0; t > i; i++) {
				var a = e[i];
				if (!v[a]) {
	...
	function n(e) {
		for (var t = {
			...
			for (var i = e[r].replace("://", "__").split("/"), a = t, o = 0, s = i.length; s > o; o++) {
				var c = i[o];
				a[c] || (a[c] = {
						__KEYS: []
					}, a.__KEYS.push(c)),
	...
	function i(e) {
		for (var t = [], r = e.__KEYS, n = 0, i = r.length; i > n; n++) {
			for (var o = r[n], s = o, c = e[o], u = c.__KEYS; 1 === u.length; )
				s += "/" + u[0], c = c[u[0]], u = c.__KEYS;
	...
	function o(e) {
		for (var t = 0, r = e.length; r > t; t++)
			for (var n = e[t], i = n[0] + "/", a = u(n[1]), o = 0, c = a.length; c > o; o++)
				s(i, a[o]);
		return v
	}
	function s(e, t) {
		var r = e + y[0] + t.join(y[1]),
		n = r.length > b;
		if (t.length > 1 && n) {
			...
			if (n)
				throw new Error("The combo url is too long: " + r);
			for (var a = 0, o = t.length; o > a; a++)
				v[e + t[a]] = r
		}
	}
	function c(e, t) {
		for (var r = y[1], n = e[0], i = 1, a = e.length; a > i; i++)
			if (n += r + e[i], n.length > t)
...
(), !function (e) {
	...
	t.isdebug = function () {
		...
		return r.replace(/isdebug=((?:-\d+)*)/, function (r, a) {
			for (n = a.split("-"), e = n.length, t = 0; t < e; t++)
				"" !== n[t] && (i[n[t]] = !0)
		}),
		i
	}
	(),
	t.baseUri = t.baseUri || "//misc.360buyimg.com/",
	t.imageLazyload = !0,
	...
	t.FN_getDomain = t.getDomain,
	t.getImageDomain = function (e) {
		var t,
		e = String(e);
	...
	t.FN_GetImageDomain = t.getImageDomain,
	t.FN_GetRandomData = function (e) {
		for (var t, r = 0, n = 0, i = [], a = 0; a < e.length; a++)
			t = e[a].weight ? parseInt(e[a].weight) : 1, i[a] = [], i[a].push(r), r += t, i[a].push(r);
	...
	t.insertStyles = function (e, t) {
		var r = document,
		n = r.getElementsByTagName("head"),
		i = r.createElement("style"),
		a = r.createElement("link");
		if (/\.css$/.test(t))
			a.rel = "stylesheet", a.type = "text/css", a.href = t, a.id = e, n.length ? n[0].appendChild(a) : r.documentElement.appendChild(a);
		else {
			if (i.setAttribute("type", "text/css"), i.id = e, i.styleSheet)
	...
	t.isRetina = !!function () {
		if (e.devicePixelRatio > 1 || e.matchMedia && e.matchMedia("(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-device-pixel-ratio: 1.5), (min-resolution: 144dpi), (min-resolution: 1.5dppx)").matches)
			return !0
	}
	(),
	...
	e.o2Control = function () {
		...
		e.prototype.set = function (e, t) {
			...
			for (r in this.store)
				n = "", i = this.store[r], i !== !1 && (n = r, i !== !0 && (n += "=" + i), a.push(n));
	...
	(),
	function (e) {
		for (var t = 0, r = ["ms", "moz", "webkit", "o"], n = 0; n < r.length && !e.requestAnimationFrame; ++n)
			e.requestAnimationFrame = e[r[n] + "RequestAnimationFrame"], e.cancelAnimationFrame = e[r[n] + "CancelAnimationFrame"] || e[r[n] + "CancelRequestAnimationFrame"];
	...
	function (e) {
		function t() {
			for (var e; !e || r.hasOwnProperty(e); )
...
(), !function () {
	...
	t = e.isdebug;
	("1" in t || "localhost" == location.hostname) && seajs.config({
		comboExcludes: /.*/
	}),
	"2" in t && (e.wideVersion = !1),
	"3" in t && (e.wideVersion = !0),
	"4" in t && (e.imageLazyload = !1),
	"5" in t && (e.sourceTag = "dev"),
	"6" in t && (e.idleTimeLoad = !0),
	"11" in t && (e.isCateUseA = !0),
	"12" in t && (e.isCateUseA = !1)
}
(), !function () {
	var e = window.pageConfig;
	if (e.wideVersion && (document.getElementsByTagName("html")[0].className = "root61"), /jd\.com|360buy\.com|jd\.hk|jd360\.hk/.test(location.hostname))
		try {
...
(), Array.prototype.forEach || (Array.prototype.forEach = function (e, t) {
	...
	for (t && (r = t), n = new Array(o), i = 0; i < o; ) {
		var s,
		c;
		i in a && (s = a[i], c = e.call(r, s, i, a), n[i] = c),
		i++
	}
	return n
});
...
(window, void 0), function (e) {
	...
	r.prototype = {
		on: function (e, t, n) {
			...
			if (!t)
				return this;
			for (e = e.split(o), r = this.callbacks; i = e.shift(); )
				c = r[i], a = c ? c.tail : {},
			a.next = s = {},
			a.context = n,
			a.callback = t,
				...
				for (e = e ? e.split(o) : a.keys(i); r = e.shift(); )
					if (s = i[r], delete i[r], s && (t || n))
						for (c = s.tail; (s = s.next) !== c; )
							u = s.callback, f = s.context, (t && u !== t || n && f !== n) && this.on(r, u, f);
				return this
			}
		},
		trigger: function (e) {
			...
			for (c = r.all, e = e.split(o), u = i.call(arguments, 1); t = e.shift(); ) {
				if (n = r[t])
					for (a = n.tail; (n = n.next) !== a; )
						n.callback.apply(n.context || this, u);
				if (n = c)
					for (a = n.tail, s = [t].concat(u); (n = n.next) !== a; )
...
(), define("o2console", function () {
	...
	for (var n, r = e._ || (e._ = {}), o = {}, i = ["assert", "cd", "clear", "count", "countReset", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "select", "table", "time", "timeEnd", "timeStamp", "timeline", "timelineEnd", "trace", "warn"], a = i.length, s = window.console = window.console || {}, c = function () {}; a--; )
		n = i[a], s[n] || (s[n] = c);
...
(window, void 0), function () {
	var e = {
		...
		getSpeedInfo: function () {
			...
			n = window.pageConfig || {},
			r = n && n.O2_REPORT;
			return void 0 !== r && "number" == typeof r || (r = 100),
			r > 0 && e >= 0 && e <= r && t > 0 ? "s" + this.getRank() + "=" + t : ""
		},
		...
		getBrowser: function () {
			...
			return (e = n.match(/rv:([\d.]+)\) like gecko/)) ? t.ie = e[1] : (e = n.match(/msie ([\d.]+)/)) ? t.ie = e[1] : (e = n.match(/firefox\/([\d.]+)/)) ? t.firefox = e[1] : (e = n.match(/metasr/)) ? t.sougou = !0 : (e = n.match(/qqbrowser/)) ? t.qq = !0 : (e = n.match(/version\/([\d.]+).*safari/)) ? t.safari = e[1] : (e = n.match(/chrome\/([\d.]+)/)) ? t.chrome = e[1] : (e = n.match(/opera.([\d.]+)/)) ? t.opera = e[1] : (e = n.match(/ipad/)) ? t.ipad = !0 : 0,
		...
		getBaseData: function () {
			...
			if (e && t) {
				...
				i = e.JS,
				a = e.DOM;
				r && n.push("s72=" + (r.getTime() - t.getTime())),
				o && n.push("s73=" + (o.getTime() - t.getTime())),
				i && n.push("s74=" + (i.getTime() - t.getTime())),
		...
		processJsError: function () {
			...
			void 0 !== r && "number" == typeof r || (r = 100),
			r > 0 && n >= 0 && n <= r && $(e).bind("error.o2report", function (t, n, r, o, i) {
				var a = "";
				if (o = o || e.event && e.event.errorCharacter || 0, i && i.stack)
					t = i.stack.toString();
				else if (arguments.callee) {
					for (var s = [t], c = arguments.callee.caller, u = 3; c && --u > 0 && (s.push(c.toString()), c !== c.caller); )
						c = c.caller;
					t = s.join(",")
				}
	...
	!function () {
		function e(e, n) {
			...
			return function (s, c, u) {
				function f(e) {
					e && e.url === n.backup && (e.cache = !0, _.eventCenter.trigger(p.jsonpCallback + ":backup", n.backup)),
					p.data = p.__data || {},
					$.extend(p, {
						url: p.originalUrl,
						forceStore: !1
				...
				p.forceBackup && (r = 0),
				r > 0 && (!e.statusCodes || $.inArray(s.status, e.statusCodes) > -1) ? (d && (i = isNaN(d) ? new Date(d).getTime() - $.now() : 1e3 * parseInt(d, 10), (isNaN(i) || i < 0) && (i = e.timeout)), void 0 !== i && r !== n.times ? a = setTimeout(f, i) : f()) : 0 === r ? "string" == typeof o && o.length > 0 ? f({
					url: o
				}) : l() : r === -1 ? l() : h.rejectWith(this, arguments),
				h
			}
		}
			...
			if (n = !!n && t.enabled) {
				...
				if (s && (o(s) || a))
					return {
						send: function (t, n) {
							var r = {};
							r[i] = e.jsonpCallback + "(" + JSON.stringify(s) + ")",
							n(200, "success", r, "")
						},
						abort: function () {
...
define("conf", function (require, exports, module) {
	"use strict";
	var e = "//www.3.cn/bup",
	o = "//f.3.cn/index-floor?argv=",
	t = "//www.3.cn/index/bak/",
	a = "//ai.jd.com",
	n = a + "/index_new.php?",
	r = "//ch.jd.com",
	i = "//diviner.jd.com/diviner",
	s = "//yuding.jd.com",
	l = "app=Seckill&action=pcIndexMiaoShaArea",
	d = "app=Newuser&action=isNewuser",
	c = "app=Discovergoods&action=getDiscZdmGoodsListForIndex",
	h = "app=ABdata&action=ABData&key=BtestData",
	u = pageConfig.dataLoadTimeout || 3e3,
	f = {
		TIMEOUT: u,
		DOMAINS: {
			BACKUP_PC: e,
		...
		SWF_PLAYER: "//misc.360buyimg.com/mtd/pc/index" + "/home/images/JDLiveVideo.swf",
	...
	t.clstagPrefix = "h|keycount|2016|",
	t.sendClog = function (e) {
		if (e.length) {
			var o = [],
			a = {},
			n = t.clog;
	...
	var a = [e.URLS.PLUS, "您可享钻石特惠，开通PLUS>"],
	n = [e.URLS.PLUS, "您可享金牌特惠，开通PLUS>"],
	r = [e.URLS.PLUS, "您可享银牌特惠，开通PLUS>"],
	i = [e.URLS.PLUS, "您可享钻石特惠，续费PLUS>"],
	s = [e.URLS.PLUS, "您可享金牌特惠，续费PLUS>"],
	l = [e.URLS.PLUS, "您可享银牌特惠，续费PLUS>"],
	d = [e.URLS.PLUS, "试用PLUS会员领免运费券>"],
	c = [e.URLS.PLUS, "试用PLUS会员享更多特权 <span class='style-red'>购买</span>"],
	h = [e.URLS.PLUS, "购买PLUS会员尊享顶级特权>"],
	u = [e.URLS.PLUS, "PLUS专享商品每周更新>"],
	f = [e.URLS.PLUS, "续费PLUS会员尊享顶级特权 <span class='style-red'>续费</span>"],
	p = [e.URLS.PLUSSALE, "PLUS专享商品每周更新>"];
	t.plusMap = [[d, c, h, p, f], [d, c, h, p, f], [r, r, r, l, l], [n, n, n, s, s], [a, a, a, i, i], [d, c, h, u, f], [d, c, h, u, f]],
	!function () {
	...
	paths: {
		HOME_BASE: "//misc.360buyimg.com/mtd/pc/index" + "/home",
...
}), seajs.use(["O2_COMPONENT/carousel/1.0.0/carousel.js", "O2_COMPONENT/util/1.0.0/util.js", "O2_COMPONENT/tab/1.0.0/tab.js", "O2_COMPONENT/lazyload/2.0.0/lazyload.js", "home/widget/head", "home/widget/cate", "home/widget/slider", "home/widget/userinfo", "home/widget/news", "home/widget/service", "report", "home/widget/patch", "home/widget/elevator"], function (e, o, t, a, n, r, i, s, l, d, c, h) {
	c.init(222, 223, 224, 260),
	$.each(["jsonCallBackenjoy", "jsonCallBackcoupons", "jsonCallBackbanner_1", "jsonCallBackbanner_2", "jsonCallBackbanner_3", "jsonCallBackbanner_4", "jsonCallBackspecial_1", "jsonCallBackspecial_2", "jsonCallBackbasic_1", "jsonCallBackbasic_2", "jsonCallBackbasic_3", "jsonCallBackbasic_4", "jsonCallBackbasic_5", "jsonCallBackbasic_6", "jsonCallBackbasic_7", "jsonCallBackbasic_8", "jsonpCallbackUserIpInfo", "jsonpCallbackEnjoyBiAct", "jsonpCallbackEnjoyBiShop", "jsonpCallbackFindGood", "jsonpCallbackAggr", "jsonpCallbackTopRank", "jsonpCallbackTopHotsale1", "jsonpCallbackTopHotsale2", "jsonpCallbackTopHotsale3", "jsonpCallbackTopHotsale4", "jsonpCallbackTopHotsale5", "jsonpCallbackMoreGood", "jsonpCallbackSeckill", "jsonpCallbackFocus", "jsonpCallbackFocusBottomRec", "jsonpCallbackIsNewuser", "jsonpCallbackRequestUserInfo", "jsonpCallbackPreloadSk", "getCategoryCallback", "jsonpCallbackHelloService", "jsonpCallbackIsLogin", "jsonpCallbackMorePreSale", "jsonpCallbackSup"], function (e, o) {
		window[o] = $.noop,
		_.eventCenter.on(o + ":backup", function () {
			c.processBackup(e + 1)
		})
	}),
	n.init(),
	...
	$(window).one("load.home2016", function () {
	...
	!function () {
		...
		new d({
			...
			data: [{
					...
					url: "virtuals/squares/1.0/js/jipiao.js"
				}, {
					url: "//misc.360buyimg.com/virtuals/squares/1.0/js/hotel.js"
				}, {
					url: "virtuals/squares/1.0/js/game.js"
				}
			]
		})
	}
	...
	return $.extend(e.prototype, new _.Events),
	...
	function e() {
		...
		["seckill:after", "enjoy:before", "enjoy:after", "fbt:after", "coupon_lazy:before", "rec_1:before", "entry_1:before", "entry_1:after", "rec_2:before", "portal_1:before", "portal_1:after", "portal_2:before", "portal_2:after", "portal_3:before", "portal_3:after", "portal_4:before", "portal_4:after", "rec_3:before", "portal_5:before", "portal_5:after", "portal_6:before", "portal_6:after", "portal_7:before", "portal_7:after", "portal_8:before", "portal_8:after", "entry_2:before", "rec_4:before", "more:after", "lift:after"].forEach(function (o, t) {
			...
			a = o[0],
			n = o[1];
			e.delegate("#" + a, "render:" + n, d[n][a])
		})
	}
	var o = (require("conf"), require("load_async"), require("logger")),
	t = window.pageConfig,
	a = t.FN_GetRandomData,
	n = t.processImageUrl,
	r = function (e) {
	...
	i = function (e, o, r, i) {
		return function (s, l, d) {
			...
			var h = c.list || [],
			u = c.live || [];
			return !h.length || "享品质" == e && !u.length ? d(!1) : (c.staticLogTag = i, c.title = e, c.list = h.map(function (e) {
						return $.isArray(e) && e.length ? a(e) : e
					}), c.list.forEach(function (e, t) {
					e.imgUrl = n(e.imgUrl, o, r)
				}), u.forEach(function (e, o) {
					e.indexImage = n(e.indexImage, "780x700", "390x350"),
					!!t.disablePlayer != !!t.isdebug[15] && (e.status = 4)
				}), void d())
		}
	},
	s = function (e, o) {
	...
	d = {
		before: {
			enjoy: function (e, o, a) {
				var n = o.data,
				r = (n.act, n.shop, t.isdebug[10] ? (new Date).getTime() : new Date(t.timestamp).getTime());
				n.fixed ? (r < new Date("2017/06/01 00:00:00").getTime() ? n.ignoreMain = !0 : l(n), a()) : a(!1)
			},
	...
	n.bind("resize.home", function () {
		var e = function () {
			var e = n.width() >= 1190;
			e ? r.removeClass("o2_mini").addClass("o2_wide root61") : r.removeClass("o2_wide root61").addClass("o2_mini"),
			a.pageConfig.wideVersion !== e && (_.eventCenter.trigger("render:floorChange"), a.pageConfig.wideVersion = e),
			_.eventCenter.trigger("home:resize", e)
		},
		o = n.width(),
		l = n.height();
		i == o && s == l || (window.clearTimeout(t), t = window.setTimeout(e, 100)),
		i = o,
		s = l
	}),
	e.bind(),
	...
	pageConfig.loginDefer = new $.Deferred,
	pageConfig.userInfoDefer = new $.Deferred
	...
	l = _.Class.extend({
			...
			init: function () {
				...
				"" !== o && e.addClass(o),
				a.consoleConfigFunc(),
				this.isChrome = e.hasClass("o2_chrome"),
				this.isIE = !!this.w.ActiveXObject || navigator.userAgent.indexOf("Trident") > 0,
				this.o2JSConfig = s ? s.o2JSConfig : {},
				this.imageLazyload = s.imageLazyload,
				...
				this.renderedFloor = [],
				this.floorResult = {},
				this.isAutoRendered = !1,
				this.lazyFloorCount = 0,
				this.aniFloorCount = 0,
				this.loadedFloorCount = 0,
				this.aniedFloorCount = 0,
				this.initFloor(),
				this.floorsInfo = this.getFloorsInfo($(".J_f")),
				this.lazyLoadFloor(),
				this.bind(),
				this.events = $._data($("body").get(0), "events")
			},
			initFloor: function () {
				var e = this,
				o = $("." + e.conf.cls);
			...
			bind: function () {
				...
				this.imageLazyload || (e.source = "nolazyload"),
				e.quality = 90,
				e.webpQuality = 90;
				var o = this,
				a = o.$w,
				...
				$("body").o2lazyload(e).bind("render", this.conf.cls, function (e, a, r) {
					...
					if (!($.inArray(s, o.renderedFloor) >= 0)) {
						var h = i.find('[type="text/template"]'),
						u = "";
						if ("object" == typeof a && a.dom ? u = a.dom : (u = h.html(), a.dom = u), o.floorResult[s] = {
								result: a
							}, c) {
							if (c && r)
								return o.detectFloorNeedAni(i) && (i.addClass(l.ACT_CLASS), o.aniedFloorCount++), i.trigger(l.RENDER_AFTER, [a, function () {
											_.eventCenter.trigger("lazyload:DOMUpdate", i),
											i.removeClass("mod_lazyload"),
											o.sendClog(i)
										}
									])
						} else
							o.renderedFloor.push(s);
						var f = $.isEmptyObject(a.data) ? null : a.data,
						p = d.source;
						if (p && (!f || $.isEmptyObject(f)))
							return void o.hideFloor(s, i);
						try {
							var g = "";
							r ? (g = t(u, f || {}), h.remove(), n.requestNextAnimationFrame(function () {
									o.detectFloorNeedAni(i) && (o.aniedFloorCount++, i.addClass(l.ACT_CLASS)),
									i.append(g),
									i.trigger(l.RENDER_AFTER, a),
									_.eventCenter.trigger("lazyload:DOMUpdate", i),
									o.sendClog(i)
				...
				_.eventCenter.on("render:floorChange", function () {
					o.floorChange = !0,
					o.windowLoaded && a.trigger(o.conf.scrollEvent.split(" ")[1])
				}),
				a.one("load.render", function () {
					o.windowLoaded = !0,
					o.preloadOffset = o.isIE ? 500 : 800,
					o.preloadOffset = o.detectNeedAni() ? 0 : o.preloadOffset,
					o.startLoadTimer = setTimeout(function () {
			...
			lazyLoadFloor: function () {
				...
				o.bind(a.scrollEvent, function (l) {
					e.isScrolling = !0,
					e.startLoadTimer && clearTimeout(e.startLoadTimer),
					e.autoLoadTimer && clearTimeout(e.autoLoadTimer),
					n && clearTimeout(n),
					e.resourceLoader && e.resourceLoader.pause(),
					n = setTimeout(function () {
							e.isScrolling = !1,
							e.floorChange && (i = e.getFloorsInfo($(".J_f")), e.floorChange = !1);
							var n = t.scrollTop(),
							r = o.height(),
							l = n + r + e.preloadOffset;
							for (var d in i) {
								var c = i[d],
								h = c.$el,
								u = !!h[0].getAttribute("data-hidden");
								(c.force || c.top <= l && c.top >= n - c.height) && h[0].className.indexOf(a.cls) >= 0 && (u ? e.renderHidden(d) : e.loadData(d, !0)),
								e.lazyFloorCount === e.loadedFloorCount && o.unbind(a.scrollEvent)
							}
			...
			hideFloor: function (e, o) {
				o.height(0).hide(),
				r.processHidedFloor(s.reportFloorHideHash[e]),
				_.eventCenter.trigger("render:floorChange", e),
				_.console.log(e + "加载失败！")
			},
			...
			loadTpl: function (e, o, t) {
				var a = this.floorsInfo[e],
				n = a.$el,
				i = n.html(),
				l = a.tpl,
				d = this.w.tplVersion;
				if (!l || !d)
					return this.triggerRender(e, i, {
						data: o
					}, t);
				var c = !0,
				h = "jsonCallBack_" + l,
				u = this.o2JSConfig.tplPathRule(l),
				f = d[l],
				p = s.tplLoadTimeout || 4e3;
				_.eventCenter.on(h + ":end", $.proxy(function (a) {
						this.loadingTpl.pop(l),
						a.data = o;
						var n = a.style;
						n && n.length > 0 && $.inArray(l, this.insertedStyles) < 0 && (s.insertStyles(l, n), this.insertedStyles.push(l)),
						this.loadingData[e] = !1,
						this.triggerRender(e, i, a, t)
					}, this)),
				$.inArray(l, this.loadingTpl) < 0 && (this.loadingTpl.push(l), this.loadCore(u, h, {
						__trigger: !0
					}, c, f, p, null, !0).fail($.proxy(function () {
							this.loadingTpl.pop(l),
							this.loadingData[e] = !1,
							this.loadedFloorCount++,
							n.removeClass(this.conf.cls).removeClass("mod_lazyload"),
							this.hideFloor(e, n),
							r.processTempl(s.reportFloorHideHash[e])
						}, this)))
			},
				...
				if (!this.loadingData[e]) {
					...
					for (var u = 0, f = 0; f < d; f++) {
						...
						case 2:
							g.push(g[1]);
						default:
							/^(cms)|(bi)$/.test(g[0]) && (p = RegExp.$1 || RegExp.$2),
							C = "cms" === p,
							g.shift(),
							_ = g[0],
							m = g[1]
						...
						var j = encodeURIComponent("jsonCallBack" + m),
						v = this.o2JSConfig.sourcePathRule(_),
						...
						if (t) {
							...
							var S = this.loadCore(v, j, y, C, E, null, i, !1, function (e) {
									return !(!e || !e.data)
								});
							"object" == typeof S && ("function" == typeof S.always ? c.push(S) : h[v] = S)
						} else {
							var b = o.get(v);
					...
					if (!t && u !== d)
						return void(this.loadingData[e] = !1);
					var w = c.length;
					if (w > 0)
						$.when.apply(null, c).done($.proxy(function () {
								var e = arguments;
								if (1 === w) {
									var o = e[0];
									h = o.data ? o.data : o
									...
									for (var t = 0; t < e.length; t++)
										for (var o = e[t][0], a = o.__uri, n = 0; n < l.length; n++)
											this.o2JSConfig.sourcePathRule(l[n]) === a && (h[l[n]] = o.data ? o.data : o)
			...
			autoLoad: function () {
				var e = this,
				o = e.conf,
				t = e.getFloorsInfo($("." + o.cls));
				if (!e.isScrolling) {
					for (var a in t) {
						var n = t[a],
						r = n.$el,
						i = !!r[0].getAttribute("data-hidden");
						i || e.loadData(a, !1)
					}
					setTimeout(function () {
						var o = $("body").find('img[data-lazy-img!="done"]'),
						t = [];
						o.each(function () {
							var e = $(this).attr("data-lazy-img");
							"string" == typeof e && e.indexOf("//") >= 0 && t.push({
								type: "image",
								uri: e
							})
						}),
			...
			renderHidden: function (e) {
				var o = this.floorsInfo[e],
				t = o.$el,
				a = this.floorResult[e],
				n = $(a.html);
				this.loadedFloorCount++,
				t.removeClass(this.conf.cls).removeClass("mod_lazyload").append(n),
				o.hidden = !1,
				this.detectFloorNeedAni(t) && (this.aniedFloorCount++, t.addClass(l.ACT_CLASS)),
				t.trigger(l.RENDER_AFTER, a.result).removeAttr("data-hidden"),
				_.eventCenter.trigger("lazyload:DOMUpdate", t)
			},
			triggerRender: function (e, o, t, a) {
				var n = this.floorsInfo[e],
				r = n.$el;
				if (r.hasClass(this.conf.cls)) {
					...
					var c = n.custom;
					a && (this.loadedFloorCount++, r.removeClass(this.conf.cls)),
					d ? r.html(o).trigger(l.RENDER_BEFORE, [t, $.proxy(function (o) {
...
!function () {
	return pageConfig.toolbar = !0,
	$("#J-global-toolbar").length ? !1 : void setTimeout(function () {
		...
		e.ad = {
			enabled: 0,
			id: "0_0_7860",
			startTime: +new Date("2017/05/25 00:00:00") / 1000,
			endTime: +new Date("2017/06/20 23:59:59") / 1000
		},
		seajs.config({
			alias: {
		...
		seajs.use(["toolbar"], function (t) {
			$('<style type="text/css">.jdm-toolbar .jdm-toolbar-footer .jdm-tbar-tab-survey .tab-ico {display: none;_display:none;}.jdm-toolbar .jdm-toolbar-footer .jdm-tbar-tab-survey .tab-text {left: 0px;width: 35px;height:30px;padding:2px 0 3px;line-height: 15px;background: #c81623;_display:block;</style>').appendTo($("head:eq(0)"));
			var n = {
				top: {
					anchor: "#"
				}
			};
			pageConfig.surveyLink && (n.feedback = {
					href: pageConfig.surveyLink
				}),
			pageConfig.awardsLink && pageConfig.awardsTitle && (n.survey = {
					href: pageConfig.awardsLink,
					title: pageConfig.awardsTitle
				}),
			e.links = n,
			pageConfig.toolbar = new t(e)
		})
	}, 3e3)
}
();