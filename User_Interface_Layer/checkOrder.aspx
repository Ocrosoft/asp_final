...
<body id="mainframe">
                                        ...
                                        <ul id="consignee-list">
                                            <li class="ui-switchable-panel ui-switchable-panel-selected" style="display: list-item;" id="consignee_index_138669292">
                                                <div class="consignee-item item-selected" id="consignee_index_div_138669292">
                                                    <span title="李达也 浙江">李达也 浙江</span><b></b>
                                                </div>
                                                <div class="addr-detail">
                                                    <span class="addr-name">李达也</span>
                                                    <span class="addr-info">浙江 杭州市 江干区 九堡镇高教园区学源街18号浙江财经大学（下沙校区）</span>
    ...
    <div class="ui-dialog" style="width: 690px; position: absolute; z-index: 10000; display: none; overflow: hidden; top: 189.5px; left: 602.5px;">
        ...
        <div class="ui-dialog-content" style="height: 458px; width: 670px; overflow: hidden;">
            ...
            <div class="form-new" id="consignee-form" name="consignee-form" style="padding-left:150px;padding-top:100px">

                <!-- 收货人start -->
                <div class="item" id="name_div">
                    <span class="label"><em>*</em>收货人</span>
                    <div class="fl">
                        <input type="text" class="itxt" id="consignee_name" name="consigneeParam.name" maxlength="20" value="李达也" />
                ...
                <div class="item">
                    ...
                    <div class="fl">
                        ...
                        <input type="text" class="itxt itxt02" id="consignee_address" name="consigneeParam.address" maxlength="50" value="高教园区学源街18号浙江财经大学（下沙校区）" data-region="浙江|杭州市|江干区|九堡镇" />
                ...
                <div class="item" id="call_div">
                    ...
                    <div class="fl">
                        ...
                        <input type="text" class="itxt itxt01" id="consignee_mobile" name="consigneeParam.mobile" onblur="check_Consignee('mobile_div')" onfocus="if(value == defaultValue){value='';}" maxlength="11" value="158****1870">
                    </div>
                ...
                <div class="item" id="postcode_div" style="display: none">
                    ...
                    <div class="fl">
                        <input type="text" class="itxt" id="consignee_postcode" name="consigneeParam.postcode" value="" placeholder="">
                ...
                <div class="item" id="email_div">
                    ...
                    <div class="fl">
                        <input type="text" class="itxt" id="consignee_email" name="consigneeParam.email" maxlength="50" onblur="check_Consignee('email_div')" value="" onfocus="if(value == defaultValue){value='';}">
